        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/clasificar" className="hover:text-primary">Clasificar Marca</Link></li>
              <li><span className="hover:text-primary cursor-pointer">Precios</span></li>
              <li><span className="hover:text-primary cursor-pointer">Cómo funciona</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><span className="hover:text-primary cursor-pointer">Términos y Condiciones</span></li>
              <li><span className="hover:text-primary cursor-pointer">Política de Privacidad</span></li>
              <li><span className="hover:text-primary cursor-pointer">Aviso Legal</span></li>
            </ul>
          </div>
